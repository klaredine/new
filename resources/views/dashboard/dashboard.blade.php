...
@section('content')
        ...
        <div class="card">
            <div class="card-body text-center">
                <div class="list-menu">
                    ...
                    <div class="item-menu text-center">
                        <div class="menu-icon">
                            <a href="/presensi/histori" class="primary" style="font-size: 40px;">
    ...
    <div class="section mt-2" id="presence-section">
        ...
        <div id="rekappresensi">
            <h3>Rekap Presensi Pegawai {{ $namabulan[$bulanini-0] }} {{ $tahunini }}</h3>
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="accessibility-sharp" style="font-size: 1.6rem;"
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="newspaper-sharp" style="font-size: 1.6rem;"
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="medkit-sharp" style="font-size: 1.6rem;"
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="document-sharp" style="font-size: 1.6rem;"
                                ...
                                <div class="card-body">
                                    <div class="historicontent">
                                        <div class="iconpresensi">
                                            <ion-icon name="finger-print" style="font-size: 48px;"
                        ...
                        @elseif($d->status == 'i')
                            <div class="card mb-1">
                                <div class="card-body">
                                    <div class="historicontent">
                                        <div class="iconpresensi">
                                            <ion-icon name="newspaper" style="font-size: 48px;"
                        ...
                        @elseif($d->status == 's')
                            <div class="card mb-1">
                                <div class="card-body">
                                    <div class="historicontent">
                                        <div class="iconpresensi">
                                            <ion-icon name="medkit-sharp" style="font-size: 48px;"
                                        ...
                                        <div class="datapresensi">
                                            ...
                                            @if (!empty($d->doc_sid))
                                                <span style="color: blue">
                                                    <ion-icon name="document-attach"></ion-icon> SID
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        @elseif($d->status == 'c')
                            <div class="card mb-1">
                                <div class="card-body">
                                    <div class="historicontent">
                                        <div class="iconpresensi">
                                            <ion-icon name="document-text" style="font-size: 48px;"
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        ...
                                        <span class="badge {{ $d->jam_in < '20:00' ? 'bg-success' : 'bg-danger' }}">
                                            {{ $d->jam_in }}
                                        </span>
                                    </div>
                                </div>
